...
def balanced(m):
    ...
    left_weight = total_mass(end(left_arm))
    right_weight = total_mass(end(right_arm))
    if left_weight * left_length == right_weight * right_length and balanced(end(left_arm)) and balanced (end(right_arm)):
        return True
    else:
        return False
