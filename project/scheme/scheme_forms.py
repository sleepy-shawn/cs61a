...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        new_exp = Pair(formals, body)
        env.define(name, do_lambda_form(new_exp, env))
        return name
        # END PROBLEM 10
    else:
...
def do_lambda_form(expressions, env):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    lambdaprocedure = LambdaProcedure(formals, expressions.rest, env)
...
def do_mu_form(expressions, env):
    ...
    # BEGIN PROBLEM 11
    "*** YOUR CODE HERE ***"
    muprocrdure = MuProcedure(formals, expressions.rest)
    return muprocrdure
    # END PROBLEM 11
